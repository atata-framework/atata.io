...
1. Choose template, e.g., **Atata NUnit Advanced Test Project (.NET 10)**, and specify project name and location.
...
1. Change the value of `<TargetFramework>` tag from `net8.0` to the needed version.
   ```xml
